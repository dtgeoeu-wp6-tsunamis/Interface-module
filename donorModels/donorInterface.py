...
"""
Functionality to get uplift data from the respective donor model. As of now, only SeisSol is a viable donor.
"""
...
def get_donorModel(choose_donormodel, filename, spatial_resolution, include_horizontal=False):
  ...
  """
  # choose corresponding donor model and get the uplift data
  if (choose_donormodel == 'seissol'):
    donor_uplift, donor_x, donor_y = get_seissol(filename, spatial_resolution, include_horizontal)
